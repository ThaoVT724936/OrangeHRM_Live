...
public class SidebarEmployeeUI {
    ...
    public static final String JOB_MENU = "";
    public static final String SALARY_MENU = "";
    public static final String REPORT_TO_MENU = "";
    public static final String QUALIFICATIONS_MENU = "";
    public static final String MEMBERSHIPS_MENU = "";
}
